//* Script Archivos Adjuntos
let filesList = [];
const classDragOver = "drag-over";
const fileInputMulti = document.querySelector("#adjuntos #fileadjuntos");
// DEMO Preview
const multiSelectorUniqPreview = document.querySelector("#adjuntos #previa");
